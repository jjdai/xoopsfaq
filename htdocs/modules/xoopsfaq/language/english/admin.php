...
define('_AM_FAQ_CATEGORY_DELETE_DSC', "Delete Check! You are about to delete this item. You can cancel this action by clicking on the cancel button or you can choose to continue.<br /><br />This action is not reversible.");
define('_AM_FAQ_CATEGORY_EDIT_DSC', "Edit Mode: You can edit this item properties here. Click the submit button to make your changes permanent or click Cancel to return you were you where.");
define('_AM_FAQ_CATEGORY_LIST_DSC', "Liste des catégories");
define('_AM_FAQ_CATEGORY_ID', "#");
define('_AM_FAQ_CATEGORY_TITLE', "Category Title:");
define('_AM_FAQ_CATEGORY_WEIGHT', "Category Weight:");
define('_AM_FAQ_CATEGORY_WEIGHT_DSC', "Ordre d'affichage des catégories");
define('_AM_FAQ_FAQ_SUBERROR', "We have encountered an Error<br />");
...
define('_AM_FAQ_CATEGORIES', "Categories");
...
define('_AM_FAQ_PERM_COLSULT', "View");
define('_AM_FAQ_PERM_ADD', "Add");
define('_AM_FAQ_PERM_EDIT', "Edite");
define('_AM_FAQ_PERM_ACTIVE', "Activate/Désactivate");
define('_AM_FAQ_PERM_DELETE', "Delete");
define('_AM_FAQ_PERM_PRINT', "Print");
define('_AM_FAQ_PERMISSIONS_CAT', "CATEGORIES");
define('_AM_FAQ_PERMISSIONS_CAT_DESC', "Permissions of categories");
define('_AM_FAQ_PERMISSIONS_FAQ', "QUESTIONS");
define('_AM_FAQ_PERMISSIONS_FAQ_DESC', "Permissons of the FAQ");
define('_AM_FAQ_PERM_MAILTO', "Send to firend");
define('_AM_FAQ_ID_MODULE', "ID of module");
define('_AM_FAQ_FOLDER', "Folder");
define('_AM_FAQ_VERSION', "Version");
define('_AM_FAQ_AUTHORS', "Auteur(s)");
define('_AM_FAQ_WEB_SITE', "WEB Site");
define('_AM_FAQ_MIN_VERSION', "Version minimum of");
define('_AM_FAQ_UPDATE_BY_SET', "Update batch");
define('_AM_FAQ_DELETE_BY_SET', "Delete batch");
define('_AM_TELLAFRIEND_OK', "The module \"Tellafriend\" is installed. The option \"Follow to a friend\" is activ");
define('_AM_TELLAFRIEND_NOT_OK', "The module \"Tellafriend\" is not installed. The option \"Follow to a friend\" is not activ");
