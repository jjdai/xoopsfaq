<?php
      ...
      $index_admin->addInfoBoxLine('id', sprintf("%1\$s : %2\$01.2f %3\$s du %4\$s", _AM_FAQ_VERSION, ($xoopsModule->getVar('version')/100), $xoopsModule->modinfo['status'], date_format(date_create($xoopsModule->modinfo['release_date']),"d/m/Y")));
